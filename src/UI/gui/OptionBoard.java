...
public class OptionBoard {
	...
	public OptionBoard() {
		...
		optionBoard.setMinHeight(optionBoard.USE_PREF_SIZE);
		optionBoard.setMinWidth(optionBoard.USE_PREF_SIZE);
		optionBoard.setMaxHeight(optionBoard.USE_PREF_SIZE);
		optionBoard.setMaxWidth(optionBoard.USE_PREF_SIZE);
